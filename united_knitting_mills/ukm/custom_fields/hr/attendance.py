...
def create_attendance_custom_fields():
    custom_fields = {
		"Attendance": [
            ...
            dict(fieldname='employee_shift_details', label='',
            ...
            dict(fieldname='total_shift_hours', label='Total Shift Hours',
				fieldtype='Float',insert_after='section_break23'),
            dict(fieldname='column_break24', label='',
				fieldtype='Column Break',insert_after='total_shift_hours'),
